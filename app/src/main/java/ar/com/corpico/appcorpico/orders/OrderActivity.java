...
public class OrderActivity extends NavitationDrawerActivity implements OnFilterAllDialogListener,DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (orderView == null) {
            orderView = OrdersListFragment.newInstance("Todas","Todos",null,null,null);
         ...
         */
        //OrdersDetailPresenter orderPresenter = new OrdersDetailPresenter(getOrders,addOrderState, getTipoCuadrilla,getCuadrillaxTipo,mGetTipoTrabajo,orderView);
