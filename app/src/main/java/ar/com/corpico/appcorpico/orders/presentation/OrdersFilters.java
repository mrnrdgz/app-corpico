    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i=0; i< mTipoTrabajo.size(); i++) {
            ...
            if(mTipoTrabajoSelected!=null){
                if(mTipoTrabajoSelected.contains(mTipoTrabajo.get(i))){
                    Tipo.isChecked();
                }
            }
            ...
            Tipo.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(android.view.View v) {
                    if (Tipo.isChecked()) {
                        ...
                        mTipoTrabajoSelected.add((Tipo.getText()).toString());
                    } else if (mTipoTrabajoSelected.contains((Tipo.getText()).toString())) {
                        // Remover indice sin selección
                        mTipoTrabajoSelected.remove(Integer.valueOf((Tipo.getText()).toString()));
                    }
                }
            });
        }
